...
int main(void)
{
    ...
    //@test: cog_list_len
    cog_test("cog_list_len for lists of zero length", (cog_list_len(list) == 0));
    ...
    cog_test("cog_list_pop for list of length 1", ( (*(cog_uint*)data) == (*c) ));
    cog_test("cog_list_pop list size decrease after pop", (cog_list_len(list) == 0));
